...
CMakeLists.txt  - cmake build file for a processor module
...
----------------------
  ...
  The SDK uses cmake for all platforms. See cmake/README.md inside the
  SDK tree for the full reference. Quick start (from the unpacked SDK):
