...
/// Passed as 'flags' parameter to add_entry()
///@{
...
/// \param name      name of entry point. If the specified location already has a name,
///                  the old name will be appended to the regular comment.
//                   This behaviour can be overwritten by AEF_NOFORCE.
//                   If name == nullptr, then the old name will be retained.
