...
#define SN_MULTI        0x4000  ///< if the specified address already has a name,
                                ///< then add the new name as a regular comment
                                ///< "Alternative name is ...". Except when the new name
                                ///< is public and the old one is not or when the old name
                                ///< is weak and the new one is not. In these cases we act
                                ///< as if bit SN_MULTI_FORCE is specified.
                                ///< If the new name only slightly differs from the old
                                ///< one, for example, only by the initial underscore or
                                ///< the artificial suffix '_##', then we ignore it.
#define SN_MULTI_FORCE  0x8000  ///< if the specified address already has a name,
                                ///< put this old name into a regular comment and
                                ///< set the specified name.
                                ///< This bit may be used only with SN_MULTI.
///@}
