...
struct processor_t
{
  ...
  enum event_t
  {
    ...
    ev_get_regfinder,           ///< Get pointer to the regfinder object.
                                ...
                                ///< the regfinder object must be initialized by the ev_init event
                                ///< and terminated by the ev_term event.
                                ///< \return (::reg_finder_t *)
    ...
    ev_is_addr_insn,            ///< Does the instruction calculate some address using an immediate operand?
                                ///< e.g. in PC such operand may be o_displ: 'lea eax, [esi+4]'
                                ///< \param[out] type  (int *) pointer to the returned instruction type:
                                ///<                           - 0 the "add" instruction (the immediate
                                ///<                             operand is a relative value)
                                ///<                           - 1 the "move" instruction (the immediate
                                ///<                             operand is an absolute value)
                                ///<                           - 2 the "sub" instruction (the immediate
                                ///<                             operand is a relative value)
                                ///< \param insn       (const ::insn_t *) instruction
